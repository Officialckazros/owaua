...
from owaua import voice as voice_mod
from owaua.scope import Scope, is_dm_scope, scope_key
...
class _BlockingTree(app_commands.CommandTree):
    ...
    async def interaction_check(self, interaction: discord.Interaction) -> bool:
        ...
        interaction.extras["owaua_tos_checked"] = True
        return True
...
def setup(
    ...
    @tree.command(name="chat", description="Talk to owaua.")
    ...
    @tree.command(name="memories", description="See what owaua remembers about you or someone.")
    ...
    @tree.command(name="request", description="Ask owaua to invent a new command.")
    ...
    @tree.command(
        name="language",
        description="Change the language owaua replies in.",
    )
    @app_commands.describe(
    ...
    async def about_cmd(interaction: discord.Interaction):
        await interaction.response.send_message(
            embed=embeds.say(
                "owaua is a privacy-first Discord assistant. Stored history is off by "
    ...
    async def privacy_cmd(interaction: discord.Interaction, action: str = "status"):
        ...
        if sub == "export":
            ...
            filename = f"owaua-user-{uid}.json"
    ...
    @tree.command(name="tos", description="Review or revoke owaua Terms of Service.")
    ...
    @tree.command(name="reflect", description="Have owaua reflect/learn from recent interactions.")
    @anywhere
    ...
    async def export_cmd(interaction: discord.Interaction):
        ...
        if len(raw) > 1800:
            ...
            await interaction.response.send_message(
                ...
                file=discord.File(buf, filename=f"owaua-export-{guild_id.replace(':', '-')}.json"),
                ephemeral=True,
            )
        else:
            await interaction.response.send_message(
    ...
    @tree.command(name="8ball", description="Have owaua answer a yes/no question.")
    ...
    @tree.command(name="lessons", description="See what owaua has learned.")
    @anywhere
