...
MODULES: Final[dict[str, dict[typing.Any, typing.Any]]] = {
    "afk": _module(
        "AFK",
        "Community",
        "Away statuses, notes, return alerts and nickname markers.",
        {
            "nickname_prefix": "[AFK]",
            "ignored_channel_ids": [],
            "enhanced_cards": True,
    ...
    "action_log": _module(
        "Action Log",
        "Safety",
        "Choose one global destination and the actor-attributed audit, message, member, role, channel, thread, server, reaction and voice events to send there.",
        {
            "channel_id": "",
            "audit_events": True,
            "message_events": True,
            ...
            "include_bot_events": True,
            "include_voice_state_changes": True,
            "bulk_delete_sample_size": 20,
            "ignored_channel_ids": [],
    ...
    "announcements": _module(
        "Announcements",
        "Community",
        "Join, leave, ban and manual announcements.",
        {
            "channel_id": "",
            "join_message": "Welcome {user.mention} to **{server.name}**!",
    ...
    "auto_delete": _module(
        "Auto Delete",
        "Automation",
        "Delete messages matching all or any configured filters.",
        {
            "rules": [],
        },
    ),
    "auto_message": _module(
        "Auto Message",
        "Automation",
        "One-time or repeating channel messages and embeds.",
        {
            "messages": [],
        },
    ),
    "auto_purge": _module(
        "Auto Purge",
        "Automation",
        "Scheduled filtered channel cleanup while preserving pins.",
        {
            "rules": [],
            "maximum_per_run": 5000,
        },
    ),
    "autoban": _module(
        "Autoban",
        "Safety",
        "Ban newly joined accounts using age and username rules.",
        {
            "minimum_account_age_hours": 0,
            "username_contains": [],
            "username_exact": [],
            "username_wildcards": [],
            "reason": "Matched an autoban rule",
        },
    ),
    "automod": _module(
        "Automod",
        "Safety",
        "Spam, words, links, mentions and phishing protection.",
        {
            "log_channel_id": "",
            "banned_phrases": [],
            "allowed_domains": [],
    ...
    "autoresponder": _module(
        "Autoresponder",
        "Community",
        "Text, embed and reaction responses with exact or wildcard triggers.",
        {
            "responders": [],
        },
    ),
    "autoroles": _module(
        "Autoroles & Ranks",
        "Community",
        "Join roles, delayed removal and self-assignable ranks.",
        {
            "join_roles": [],
            "ranks": [],
            "one_rank_only": False,
    ...
    "boosters": _module(
        "Booster Perks",
        "Engagement",
        "Boost history, greetings, personal roles and channels, rewards, reactions, counters and logs.",
        {
            ...
            "greet_author": "",
            "greet_author_icon": "",
            "greet_title": "Thank you for boosting!",
            "greet_footer": "",
            "greet_footer_icon": "",
            "greet_thumbnail": "",
            "greet_image": "",
            ...
            "greet_addon": "",
            "greet_dm": False,
            "greet_include_stats": True,
            "greet_reaction": "",
            "react_original": False,
            "react_custom": False,
            "automatic_role_enabled": True,
            "automatic_role_id": "",
            "stop_remove_role_id": "",
            "personal_roles_enabled": True,
            "personal_role_min_boosts": 1,
            "personal_role_base_role_id": "",
            "personal_role_allow_hoist": False,
            "personal_role_allowed_colors": [],
            "personal_role_prefix": "",
            "personal_role_suffix": "",
            "personal_role_banned_words": [],
            "qualifying_role_ids": [],
            "revoke_role_ids": [],
            "delete_ineligible_personal_role": True,
            "role_gifts_enabled": True,
            "role_gift_min_boosts": 1,
            "role_gift_slots": 1,
            "boost_level_roles": [],
            "boost_age_roles": [],
            "private_channels_enabled": True,
            "private_channel_category_id": "",
            "private_channel_type": "text",
            "private_channel_min_boosts": 1,
            "private_channel_friend_slots": 0,
            "private_channel_invite_min_boosts": 1,
            "private_channel_allow_role_ids": [],
            "private_channel_deny_role_ids": [],
            "private_channel_manager_access": True,
            "mention_reactions_enabled": True,
            "mention_reaction_min_boosts": 1,
            "emoji_restrictions_enabled": True,
            "emoji_restrictions": [],
            "normal_emoji_role_ids": [],
            "animated_emoji_role_ids": [],
            "stat_channels": [],
            "log_channel_id": "",
            "log_color": "5865f2",
    ...
    "custom_commands": _module(
        "Custom Commands",
        "Community",
        "Custom responses, variables, routing, permissions and cooldowns.",
        {
            "commands": [],
        },
    ...
    "economy": _module(
        "Economy & Cards",
        "Engagement",
        "Coins, gems, streaks, cards, decks, fusion and battles.",
        {
            "daily_base": 100,
            "work_min": 20,
            "work_max": 80,
            "battle_stamina_max": 10,
            "cards_enabled": True,
            "battle_pass_bonus_percent": 0,
        },
        default_enabled=True,
        implementation="partial",
    ),
    "forms": _module(
        "Forms",
        "Support",
        "Public Discord-linked forms, permissions and submission automation.",
        {
            "public_base_url": "https://kozzyx.org",
            "forms": [],
        },
    ),
    "fun": _module(
        "Fun",
        "Engagement",
        "Games, media, polls and information commands.",
        {
            "allowed_channel_ids": [],
            "disabled_commands": [],
        },
    ...
    "giveaways": _module(
        "Giveaways",
        "Engagement",
        "Timed button giveaways, eligibility, roles and rerolls.",
        {
            "giveaways": [],
        },
        implementation="partial",
    ...
    "highlights": _module(
        "Highlights",
        "Community",
        "DM users when their subscribed phrases are mentioned.",
        {
            "ignored_channel_ids": [],
        },
    ),
    "kick": _module(
        "Kick Notifications",
        "Feeds",
        "Kick live notifications through messages or webhooks.",
        {
            "subscriptions": [],
            "poll_minutes": 5,
        },
    ...
    "levels": _module(
        "Levels",
        "Engagement",
        "Chat XP, rewards, multipliers, profiles and leaderboards.",
        {
            "xp_min": 8,
            "xp_max": 15,
            "cooldown_seconds": 60,
            "level_up_channel_id": "",
            "level_up_message": "{user.mention} reached level **{level}**!",
            "reward_roles": [],
    ...
    "moderation": _module(
        "Moderation",
        "Safety",
        "Cases, warnings, timeouts, bans, notes, locks, purge and appeals.",
        {
            "moderator_role_ids": [],
            "protected_role_ids": [],
            "log_channel_id": "",
            "dm_actions": True,
            "appeal_url": "",
            "remove_roles_while_muted": False,
            "appeals_enabled": True,
            "appeal_channel_id": "",
            "case_expiry_days": 30,
            "member_notes_enabled": True,
            "evidence_links_enabled": True,
            "preserve_ban_messages": True,
            "autopunish": [],
            "custom_responses": {},
        },
        default_enabled=True,
    ...
    "incident_center": _module(
        "Staff Incident Center",
        "Safety",
        "Unified assignable queue for malware, automod, rules, assistant actions, cases and tickets.",
        {
            "staff_role_ids": [],
            "escalation_role_ids": [],
            "default_assignee_id": "",
    ...
    "reaction_roles": _module(
        "Reaction Roles",
        "Community",
        "Reaction, button and dropdown role menus.",
        {
            "menus": [],
            "persistent_components": True,
            "remove_on_unselect": True,
            "require_rules_ack": False,
            "maximum_roles_per_menu": 25,
        },
        implementation="core live",
    ),
    "reddit": _module(
        "Reddit",
        "Feeds",
        "Post new subreddit submissions with flair and NSFW filters.",
        {
            "subscriptions": [],
            "poll_minutes": 5,
        },
    ...
    "reminders": _module(
        "Reminders",
        "Utility",
        "Personal reminders with jump links.",
        {
    ...
    "slowmode": _module(
        "Slowmode",
        "Safety",
        "Discord-native or bot-enforced per-channel rate limits.",
        {
            "channels": [],
        },
    ),
    "starboard": _module(
        "Starboard",
        "Engagement",
        "Highlight popular messages and collect star statistics.",
        {
            "channel_id": "",
            "emoji": "⭐",
            "threshold": 3,
    ...
    "tags": _module(
        "Tags",
        "Community",
        "Categorized reusable server text.",
        {
            "creator_role_ids": [],
        },
    ),
    "tickets": _module(
        "Tickets",
        "Support",
        "Private ticket panels, intake fields, routing and transcripts.",
        {
            "category_id": "",
            ...
            "allow_member_close": True,
            "assignment_mode": "manual",
            "max_open_per_member": 5,
    ...
    "tiktok": _module(
        "TikTok",
        "Feeds",
        "New TikTok notifications and previews.",
        {
            "subscriptions": [],
            "poll_minutes": 5,
        },
    ...
    "youtube": _module(
        "YouTube",
        "Feeds",
        "Video, Shorts and livestream notifications.",
        {
            "subscriptions": [],
            "poll_minutes": 5,
        },
    ...
    "voice_text": _module(
        "Voice Text Linking",
        "Community",
        "Grant linked text access while members are in voice.",
        {
            "bindings": [],
        },
    ),
    "welcome": _module(
        "Welcome",
        "Community",
        "Channel, DM and image welcomes with variables.",
        {
            "channel_id": "",
            ...
            "intro_questions": [],
            "starter_channel_ids": [],
            "help_followup_hours": 24,
            "help_message": "Need a hand getting started?",
        },
        implementation="core live",
    ),
    "scheduled_digests": _module(
        "Scheduled Digests",
        "Automation",
        "Explicit daily or weekly staff summaries with bounded aggregate sections.",
        {
            "enabled_cadences": [],
            "daily_channel_id": "",
            "weekly_channel_id": "",
    ...
    "server_health": _module(
        "Server Health Advisor",
        "Safety",
        "Explanatory weekly configuration and workflow recommendations that never auto-change settings.",
        {
            "weekly_enabled": True,
            "delivery_channel_id": "",
            "staff_only": True,
            ...
            "check_logging": True,
            "check_tickets": True,
            "check_automod_noise": True,
            "check_booster_drift": True,
        },
        default_enabled=True,
        implementation="core live",
    ),
    "analytics_exports": _module(
        "Analytics & Retention",
        "Administration",
        "Aggregate CSV exports and per-module retention transparency without message content or profiles.",
        {
    ...
    "server_management": _module(
        "Server Management",
        "Administration",
        "Role, nickname, member, invite and emoji utilities.",
        {
            "manager_role_ids": [],
            "ignored_user_ids": [],
            "ignored_role_ids": [],
    ...
    "bot_controls": _module(
        "Bot Controls",
        "Administration",
        "Command/module switches, permissions, prefix and diagnostics.",
        {
            "prefix": "",
            "disabled_commands": [],
            "allowed_role_ids": [],
...
SERVER_SETTINGS: Final[dict[str, dict[typing.Any, typing.Any]]] = {
    ...
    "opinion_profile": {
        ...
        "description": "Optional server-specific tastes or standards that refine owaua's default viewpoints.",
        "kind": "textarea",
        "default": "",
        "max_length": 2000,
    },
    ...
    "modlog_channel": {
        ...
        "description": "Must be a private text channel writable by owaua.",
        "kind": "channel_id",
        "default": "",
    },
    "rules_enabled": {
...
def default_settings(name: str) -> dict[typing.Any, typing.Any]:
...
def public_catalog() -> list[dict[typing.Any, typing.Any]]:
    return [{"id": name, **deepcopy(definition)} for name, definition in MODULES.items()]


def default_server_settings() -> dict[typing.Any, typing.Any]:
    return {key: deepcopy(definition["default"]) for key, definition in SERVER_SETTINGS.items()}


def public_server_settings() -> list[dict[typing.Any, typing.Any]]:
    return [{"key": key, **deepcopy(definition)} for key, definition in SERVER_SETTINGS.items()]


def merge_server_settings(value: object) -> dict[typing.Any, typing.Any]:
    """Return the complete, bounded set of dashboard-editable guild settings."""
    clean = default_server_settings()
    if not isinstance(value, dict):
        return clean
    if len(typing.cast(typing.Any, value)) > len(SERVER_SETTINGS) + 20:
    ...
    for key, candidate in typing.cast(typing.Iterable[typing.Any], value.items()):
        ...
        if kind == "boolean" and isinstance(candidate, bool):
            ...
            if (
                kind == "model"
                and text
                and not all(char.isalnum() or char in "._:/-" for char in text)
            ):
                continue
            if (
                key == "language"
            ...
            clean[key] = list(
                dict.fromkeys(
                    str(item)
                    for item in typing.cast(typing.Iterable[typing.Any], candidate)
...
def merge_settings(name: str, value: object) -> dict[typing.Any, typing.Any]:
    """Return a bounded, type-compatible settings object for a module."""
    defaults = default_settings(name)
    if not isinstance(value, dict):
        return defaults
    if name == "action_log" and not typing.cast(typing.Any, value).get("channel_id"):
        legacy_destinations = (
            "default_channel_id",
            "audit_channel_id",
            "message_channel_id",
        ...
        migrated: typing.Any = typing.cast(
            typing.Any,
            next(
                (
                    typing.cast(typing.Any, value).get(key)
                    for key in legacy_destinations
                    if typing.cast(typing.Any, value).get(key)
                ),
                "",
            ),
        )
    ...
    for key, candidate in typing.cast(typing.Iterable[typing.Any], value.items()):
        ...
        if isinstance(expected, bool) and isinstance(candidate, bool):
            ...
            if key.endswith("_ids"):
                defaults[key] = list(
                    dict.fromkeys(
                        str(typing.cast(typing.Any, item))
                        for item in typing.cast(list[typing.Any], candidate)
                        if str(typing.cast(typing.Any, item)).isdigit()
                        and len(str(typing.cast(typing.Any, item))) <= 24
                    )
                )[:500]
            else:
            ...
            defaults[key] = dict(
                typing.cast(typing.Any, list(typing.cast(typing.Any, candidate.items()))[:500])
            )
    return defaults
