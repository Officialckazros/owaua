...
guild, SefBot backfills every message it can read from Discord and captures new
...
tokens are used only to complete sign-in and are not stored by OpSef.</li>
</ul>
