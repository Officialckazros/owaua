...
from sefbot import ai_control, config, db, staffops
...
_JS: Final = r"""
const state={csrf:"",catalog:[],configs:new Map(),guilds:[],guildId:"",guildReady:false,category:"All",editing:null,serverSchema:[],serverSettings:{},boosterData:null,operations:null,aiHealth:null,loadId:0,boosterLoadId:0,activityLoadId:0,operationsLoadId:0,loading:false};
