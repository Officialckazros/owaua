...
from sefbot import ai_control, config, db, multilingual, staffops
...
const viewCopy={overview:["Overview","Server configuration and activity"],modules:["Modules","Enable and configure server features"],language:["Language","Localize this guild's entire SefBot experience"],boosters:["Booster Perks","Track boosts and manage every booster reward"],operations:["Incident Center","Cases, incidents, tickets, health and retention in one staff view"],settings:["Settings","Core AI, privacy, moderation, rules, voice and channel behavior"],activity:["Activity","Authenticated dashboard changes for this server"]};
