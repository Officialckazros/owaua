...
@media(max-width:520px){.login-card{padding:1.25rem}.hero-panel{display:block}.hero-panel .primary{width:100%;margin-top:1rem}.stats,#booster-stats{grid-template-columns:minmax(0,1fr)}.stat{border-right:0;border-bottom:1px solid var(--white)}.stat:last-child{border-right:0;border-bottom:0}.module-grid,.editor-fields,.settings-grid,.booster-group-fields,.collection-row,.ops-form,.structured-object-field{grid-template-columns:minmax(0,1fr)}.settings-grid .field.full,.booster-group-fields .full,.ops-form .full{grid-column:auto}.inline-form{grid-template-columns:minmax(0,1fr)}.booster-actions{display:grid}.structured-children{padding-left:0}.structured-remove{justify-self:start}}
"""
...
q("#editor-fields").onclick=handleStructuredClick;q("#editor-fields").onchange=handleStructuredChange;
