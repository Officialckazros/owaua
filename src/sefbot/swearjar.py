...
_SWEAR_WORDS: Final = (
    "arse", "arsehole", "ass", "asshat", "asshole", "asswipe", "badass", "ballsack",
    "bastard", "bastards", "bellend", "bitch", "bloody", "bollock", "bollocks", "boob",
    "boobs", "bugger", "bullshit", "cock", "crap", "crappy", "cunt", "damn", "dammit",
    "dick", "dickhead", "dickheads", "dickweed", "dickwad", "dipshit", "douche", "douchebag",
    "dumbass", "effing", "fkn", "flog", "fuck", "fucked", "fucker", "fucking", "fuckface",
    "fuckhead", "fuckwit", "frigging", "fricking", "goddamn", "goddammit", "git", "hell",
    "jackass", "knob", "knobhead", "motherfucker", "motherfuckers", "motherfucking", "nonce",
    "pillock", "piss", "pissed", "prick", "pussy", "screw", "shit", "shitface", "shithole",
    "shithead", "shitty", "slut", "sod", "stfu", "suck", "sucks", "tosser", "twat", "turd",
    "tit", "tits", "wank", "wanker", "whore", "wtf",
)
_SWEAR_PATTERN: Final = re.compile(
    ...
    + "|".join(
        sorted(
            (
                "[^a-z0-9]*".join(f"{re.escape(char)}+" for char in word)
